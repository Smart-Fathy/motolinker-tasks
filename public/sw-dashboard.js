const CACHE = 'motolinker-dash-v75';
const SHELL = ['/dashboard', '/manifest-dashboard.json', '/help-docs.js', '/assets/dashboard.css', '/assets/mobile.css', '/assets/dashboard.js', '/assets/home.js', '/assets/huddle.js', '/assets/chat-extras.js', '/assets/lead-filters.js'];
