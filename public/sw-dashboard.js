const CACHE = 'motolinker-dash-v100';
...
const SHELL = ['/dashboard', '/manifest-dashboard.json', '/help-docs.js?v=' + V, '/assets/dashboard.css?v=' + V, '/assets/mobile.css?v=' + V, '/assets/dashboard.js?v=' + V, '/assets/home.js?v=' + V, '/assets/huddle.js?v=' + V,
  '/assets/procurement.js?v=' + V, '/assets/quote.js?v=' + V, '/assets/meetings.js?v=' + V, '/assets/availability.js?v=' + V, '/assets/chat-extras.js?v=' + V, '/assets/columns.js?v=' + V, '/assets/client-folder.js?v=' + V, '/assets/lead-filters.js?v=' + V, '/assets/mobile.js?v=' + V];
