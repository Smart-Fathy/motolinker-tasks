...
// Car Stock lives in the shared procurement.js now — both portals render the same
// page from it. What stays here is the dashboard-only part: CSV bulk upload and
// deleting a vehicle.
